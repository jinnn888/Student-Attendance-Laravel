                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('classes.update', $class->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input value='{{ $class->name }}' type="text" name="name" id="name" class="form-control" placeholder="Class name">
                            <x-input-error :messages="$errors->get('name')" class="mt-2" />
                        </div>
                        <div class="mb-3">
                            <label for="grade_level" class="block text-gray-700 font-medium">Grade Level</label>
                            <input value='{{ $class->grade_level }}' type="number" name="grade_level" id="name" class="form-control" placeholder="Grade 7 - 12">
